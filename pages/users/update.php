                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            <div class="card info-card p-3 mb-5 animate__animated animate__fadeInLeft">
                                <span class="fw-bold fs-3">Edit Users</span>
                                <hr>
                                <div class="col-md-8">
                                    <form action="act_update.php" method="POST">
                                        <input type="hidden" name="id" value="<?= $row["id"]; ?>">
                                        <input type="hidden" name="userLama" value="<?= $row["username"]; ?>">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <small class="fst-italic text-danger">fill in if you want to change the password</small>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <?php if ($row['level'] == "admin") { ?>
                                                <input type="radio" class="form-check-input" name="level" value="admin" checked> Admin
                                                <input type="radio" class="form-check-input" name="level" value="kasir"> Kasir
                                            <?php } else { ?>
