					...
					<div class="row">
						...
						<div class="col-xxl-12 col-md-12">
							<div class="card info-card p-3 mb-5 animate__animated animate__fadeInLeft">
								<span class="fw-bold fs-3">Edit Barang</span>
								<hr>
								<div class="col-md-8">
									<form method="POST" action="act_update.php">
										<input type="hidden" name="id" value="<?= $data['id_barang']; ?>">
										<input type="hidden" name="barang_lama" value="<?= $data['nama_barang']; ?>">
										<div class="mb-3">
											<label>Nama Barang</label>
											<input type="text" name="nam_bar" class="form-control" value="<?= $data['nama_barang']; ?>" required>
										</div>
										...
										<div class="mb-3">
											...
											<select name="kategori" class="form-select" required>
												...
												while ($datakat = mysqli_fetch_array($result2)) {
													if ($data['id_kategori'] == $datakat['id_kategori']) { ?>
														<option value="<?= $datakat['id_kategori'] ?>" selected><?= $datakat['nama_kategori'] ?> </option>
													<?php } else { ?>
														<option value="<?= $datakat['id_kategori'] ?>"><?= $datakat['nama_kategori'] ?> </option>
												<?php }
												} ?>
											</select>
										</div>
										...
										<div class="mb-3">
											...
											<input type="text" name="harga_beli" class="form-control" value="<?= $data['harga_beli']; ?>" required>
										</div>
										...
										<div class="mb-3">
											<label>Diskon</label>
											<input type="text" name="diskon" class="form-control" value="<?= $data['diskon']; ?>" required>
										</div>
