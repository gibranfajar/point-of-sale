    ...
    <aside id="sidebar" class="sidebar">
        ...
        <?php if ($_SESSION["level"] == "admin") { ?>
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-target="#components-nav-category" data-bs-toggle="collapse" href="#">
                        <i class="bi bi-plus"></i><span>Kategori</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="components-nav-category" class="nav-content " data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="create.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            <div class="card info-card p-3 mb-5 animate__animated animate__fadeInLeft">
                                <span class="fw-bold fs-3">Data Kategori</span>
                                <hr>
                                            ...
                                            <tbody>
                                                <tr class="text-start">
                                                    ...
                                                    <td class="text-center">
                                                        <span class="badge bg-warning p-2 px-3"><a href="update.php?id=<?= $row['id_kategori']; ?>" class="text-dark">Edit</a></span>
                                                        <span class="badge bg-danger p-2 px-3"><a href="act_delete.php?id=<?= $row['id_kategori']; ?>" class="text-white">Delete</a></span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        <?php
